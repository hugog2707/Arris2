...
--
-- Servidor: localhost
-- Tiempo de generación: 11-11-2022 a las 22:09:29
...
INSERT INTO `detalle_de_compras` (`id_detalle_compras`, `cantidad`, `subtotal`, `id_producto`, `id_compras`) VALUES
(202010, 5, 200000, 9010, 303010),
(202011, 8, 240000, 9012, 303011),
(202012, 20, 1700000, 9013, 303012),
(202013, 10, 200000, 9014, 303013),
(202014, 8, 256000, 9015, 303014),
(202015, 9, 162000, 9016, 303015),
(202016, 5, 140000, 9017, 303016),
(202017, 3, 120000, 9018, 303011),
(202018, 7, 280000, 9018, 303019),
(202019, 2, 50000, 9011, 303020),
(202020, 3, 255000, 9013, 303020),
(202021, 2, 80000, 9018, 303017),
(202022, 1, 40000, 9018, 303016),
(202023, 2, 80000, 9018, 303013),
(202024, 2, 80000, 9018, 303014),
(202025, 2, 80000, 9018, 303014),
(202026, 2, 80000, 9018, 303014),
(202027, 2, 80000, 9018, 303014),
(202028, 2, 80000, 9018, 303014),
(202029, 2, 80000, 9018, 303014),
(202030, 2, 80000, 9018, 303014),
(202031, 2, 80000, 9018, 303013),
(202032, 1, 40000, 9010, 303011),
(202033, 5, 200000, 9010, 303020),
(202034, 3, 120000, 9010, 303022),
(202035, 10, 400000, 9010, 303022);
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `compras_regis` AFTER INSERT ON `detalle_de_compras` FOR EACH ROW begin
...
CREATE TABLE `detalle_de_pedido` (
  ...
  `envio` varchar(45) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `detalle_de_pedido` (`id_detalle_pedido`, `cantidad`, `precio`, `total`, `id_producto`, `id_pedido`, `estado`, `envio`) VALUES
(8010, 4, 40000, 160000, 9010, 4010, 'Error en la venta', ''),
(8011, 6, 25000, 150000, 9011, 4010, 'Activo', ''),
(8012, 2, 30000, 60000, 9012, 4011, 'Activo', ''),
(8013, 7, 85000, 595000, 9013, 4011, 'Error en la venta', ''),
(8014, 3, 20000, 60000, 9014, 4012, 'Activo', ''),
(8015, 4, 32000, 128000, 9015, 4013, 'Activo', ''),
(8016, 1, 18000, 18000, 9016, 4014, 'Activo', ''),
(8017, 2, 28000, 56000, 9017, 4015, 'Activo', ''),
(8024, 3, 32000, 96000, 9015, 4012, 'Activo', ''),
(8025, 2, 30000, 60000, 9012, 4011, 'Activo', ''),
(8026, 10, 40000, 400000, 9010, 4014, 'Activo', ''),
(8027, 3, 40000, 120000, 9010, 4019, 'Error en la venta', ''),
(8028, 6, 32000, 192000, 9015, 4024, 'Error en la venta', ''),
(8029, 10, 25000, 250000, 9011, 4011, 'Activo', ''),
(8030, 2, 25000, 50000, 9011, 4024, 'Activo', ''),
(8031, 5, 30000, 150000, 9012, 4017, 'Activo', ''),
(8032, 2, 18000, 36000, 9016, 4013, 'Activo', ''),
(8033, 9, 40000, 360000, 9010, 4010, 'Activo', ''),
(8034, 8, 25000, 200000, 9011, 4011, 'Activo', ''),
(8035, 7, 25000, 175000, 9011, 4010, 'Activo', ''),
(8036, 7, 40000, 280000, 9010, 4026, 'Activo', ''),
(8037, 3, 30000, 90000, 9012, 4026, 'Activo', ''),
(8038, 3, 18000, 54000, 9016, 4028, 'Activo', ''),
(8039, 10, 85000, 850000, 9013, 4028, 'Error en la venta', ''),
(8040, 1, 40000, 40000, 9018, 4011, 'Activo', ''),
(8048, 4, 20000, 80000, 9014, 4013, 'Activo', ''),
(8054, 4, 20000, 80000, 9014, 4011, 'Activo', ''),
(8074, 1, 20000, 20000, 9014, 4011, 'Activo', ''),
(8076, 1, 20000, 20000, 9014, 4011, 'Activo', ''),
(8077, 2, 18000, 36000, 9016, 4012, 'Activo', ''),
(8078, 3, 40000, 120000, 9010, 4012, 'Activo', ''),
(8079, 3, 85000, 255000, 9013, 4015, 'Activo', ''),
(8080, 1, 40000, 40000, 9018, 4028, 'Activo', ''),
(8081, 2, 40000, 80000, 9018, 4010, 'Activo', ''),
(8082, 2, 40000, 80000, 9018, 4010, 'Activo', ''),
(8086, 2, 40000, 80000, 9018, 4013, 'Activo', ''),
(8090, 4, 40000, 160000, 9018, 4014, 'Activo', ''),
(8091, 2, 40000, 80000, 9018, 4014, 'Activo', ''),
(8092, 2, 40000, 80000, 9018, 4014, 'Activo', ''),
(8093, 2, 40000, 80000, 9018, 4014, 'Activo', ''),
(8094, 2, 40000, 80000, 9018, 4013, 'Activo', ''),
(8095, 2, 40000, 80000, 9018, 4012, 'Activo', ''),
(8096, 1, 40000, 40000, 9010, 4012, 'Activo', ''),
(8097, 2, 40000, 80000, 9010, 4033, 'Activo', ''),
(8098, 1, 40000, 40000, 9010, 4033, 'Error en la venta', ''),
(8099, 1, 40000, 40000, 9010, 4034, 'Activo', ''),
(8100, 1, 40000, 40000, 9010, 4034, 'Activo', ''),
(8101, 1, 40000, 40000, 9010, 4034, 'Activo', ''),
(8103, 1, 40000, 40000, 9010, 4034, 'Activo', 'si'),
(8104, 1, 40000, 40000, 9010, 4033, 'Activo', 'no'),
(8105, 1, 40000, 40000, 9010, 4034, 'Activo', 'si');
...
CREATE TRIGGER `disminuir_cantidad_disponibilidad_productos` BEFORE INSERT ON `detalle_de_pedido` FOR EACH ROW BEGIN
 ...
 ELSE
 set msg = concat('MyTriggerError: Trying to insert a negative value in trigger_test: '); signal sqlstate '45000' set message_text = msg;
 END IF;
 END
$$
DELIMITER ;
...
CREATE TRIGGER `insertar_total_precio_detalle_venta` BEFORE INSERT ON `detalle_de_pedido` FOR EACH ROW begin
   set new.precio = (SELECT precio from producto where id_producto = new.id_producto), new.total = new.precio*new.cantidad; 
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `insertar_venta_despues_del_pedidos` AFTER INSERT ON `detalle_de_pedido` FOR EACH ROW INSERT INTO venta (venta.producto,venta.fecha,venta.impuesto,venta.id_pedido, venta.envio) VALUES((SELECT producto.nombre FROM producto WHERE producto.id_producto = new.id_producto), now(),19,new.id_pedido, new.envio)
$$
DELIMITER ;
...
CREATE TABLE `envios` (
  ...
  `empresa` varchar(245) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `envios` (`id_envio`, `fecha_de_entrega`, `estado`, `id_venta`, `empresa`) VALUES
(6010, NULL, 'En proceso', 301010, ''),
(6011, NULL, 'En proceso', 301011, ''),
(6012, NULL, 'Entregado', 301012, ''),
(6013, NULL, 'Error de entrega', 301013, ''),
(6014, NULL, 'En proceso', 301051, ''),
(6015, NULL, 'En proceso', 301053, NULL);
...
--
DELIMITER $$
CREATE TRIGGER `registrar_invertario` AFTER INSERT ON `inventario` FOR EACH ROW begin
insert into producto(nombre,categoria,precio) values(nombre,categoria,precio);
end
$$
DELIMITER ;
...
CREATE TABLE `movimientos` (
  `id_movimiento` int(11) NOT NULL,
  `tipo_de_movimiento` varchar(20) CHARACTER SET utf8mb4 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `pqrs` (
  ...
  `tipo_pqrs` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
  `descripcion_pqrs` varchar(100) CHARACTER SET utf8mb4 NOT NULL,
  `estado_pqrs` varchar(45) CHARACTER SET utf8mb4 DEFAULT NULL,
  `fecha` date DEFAULT NULL,
  `id_venta` int(11) NOT NULL,
  `respuesta` varchar(245) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `pqrs` (`id_pqrs`, `tipo_pqrs`, `descripcion_pqrs`, `estado_pqrs`, `fecha`, `id_venta`, `respuesta`) VALUES
(5010, 'pregunta', '¿quiero saber cuanto tiempo tiene de garantia?\r\n', 'respondido', '2022-03-27', 301011, 'Estamos trabajando para brindar el mejor servicio'),
(5011, 'queja', 'la verdad un poco sucia la ropa', 'respondido', '2022-06-05', 301013, 'hola como vas'),
(5012, 'reclamo', 'quiero que me devuelvan el dinero, las prendas estan rotas', 'respondido', '2022-06-20', 301014, 'hola'),
(5013, 'sugerencia', 'mejoren su servicio al cliente', 'respondido', '2022-07-11', 301015, '123'),
(5014, 'Queja', 'dasfsadgasfdg', NULL, NULL, 301047, NULL),
(5015, 'Reclamo', 'xxxxx', NULL, '2022-10-27', 301047, NULL),
(5016, 'Reclamo', 'qqqqqqq', 'respondido', '2022-10-27', 301047, 'prueba de respuesta'),
(5017, 'Sugerencia', 'ppppppppp', 'pendiente', '2022-10-27', 301047, ''),
(5018, 'Reclamo', 'esto es prueba', 'Pendiente', '2022-10-28', 301046, NULL);

--
-- Disparadores `pqrs`
--
DELIMITER $$
CREATE TRIGGER `insertar_fecha_estado_pqrs` BEFORE INSERT ON `pqrs` FOR EACH ROW begin
    SET new.fecha = NOW();
...
CREATE TABLE `producto` (
  ...
  `estado` varchar(245) COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `producto` (`id_producto`, `nombre`, `categoria`, `precio`, `estado`, `disponibles`) VALUES
(9010, 'camisa hombre', 'hombre', 40000, 'Descontinuado', 9),
(9011, 'pantalon niño', 'niño', 25000, 'Inactivo', 0),
(9012, 'short mujer', 'mujer', 30000, 'Descontinuado', 0),
(9013, 'chaqueta unisex', 'unisex', 85000, 'Agotado', 0),
(9014, 'blusa blanca', 'mujer', 20000, 'Activo', 0),
(9015, 'camiseta de cuadros', 'hombre', 32000, 'Activo', 0),
(9016, 'buso pequeño', 'niño', 18000, 'Activo', 0),
(9017, 'jogger rojo', 'unisex', 28000, 'Activo', 0),
(9018, 'falda', 'mujer', 40000, 'Activo', 0),
(9019, 'blusa manga corta', 'mujer', 65000, 'Activo', 0),
(9022, 'dril en tela', 'hombre', 66000, 'Activo', 0),
(9023, 'levis', 'unisex', 33000, 'Activo', NULL),
(9024, '', '', 0, 'Agotado', NULL),
(9025, '', '', 0, NULL, 0),
(9026, '', '', 0, NULL, NULL),
(9027, '', '', 0, NULL, NULL),
...
(9035, '', '', 0, NULL, NULL),
(9036, '', '', 0, NULL, NULL),
(9037, 'gaban', 'unisex', 70000, 'Activo', NULL),
(9038, '', '', 0, 'Activo', NULL),
(9039, '', '', 0, 'Activo', NULL),
(9040, '', '', 0, 'Activo', NULL),
(9041, '', '', 0, 'Activo', NULL);
...
CREATE TABLE `proveedores` (
  `id_proveedor` bigint(20) NOT NULL,
  `nombre_de_proveedor` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `respuesta_pqrs` (
  ...
  `id_pqrs` int(11) NOT NULL,
  `respuesta` varchar(100) CHARACTER SET utf8mb4 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `roles` (
  ...
  `nombre_de_rol` varchar(50) CHARACTER SET utf8mb4 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `usuarios` (
  ...
  `direccion` varchar(80) CHARACTER SET utf8mb4 NOT NULL,
...
(323232, 'zzz', 323232788, 'z@z.com', 'zzzzzzz', '$2a$10$l.BumQXMv3iZcVDuBy9Uou9IkmPDsh0FV81gi8rTo1N3wwx7OOpJC'),
...
insert into roles_usuarios (id_rol,id_usuario) values (1010,_id_usuario);
END
$$
DELIMITER ;
...
INSERT INTO `venta` (`id_venta`, `producto`, `fecha`, `impuesto`, `id_pedido`, `envio`) VALUES
(301010, 'camisa hombre', '2022-03-24 19:06:59', 19, 4010, ''),
(301011, 'pantalon niño', '2022-03-25 19:07:56', 19, 4010, ''),
(301012, 'short mujer', '2022-03-26 19:07:56', 19, 4011, ''),
(301013, 'chaqueta unisex', '2022-03-27 19:07:56', 19, 4011, ''),
(301014, 'blusa blanca', '2022-04-10 18:20:20', 19, 4012, ''),
(301015, 'camiseta de cuadros', '2022-04-22 18:20:20', 19, 4013, ''),
(301016, 'buso pequeño', '2022-05-08 18:20:20', 19, 4014, ''),
(301017, 'jogger rojo', '2022-05-09 18:20:20', 19, 4015, ''),
(301018, 'short mujer', '2022-09-18 22:45:56', 19, 4014, ''),
(301019, '51', '2022-10-13 21:43:57', 19, 4010, ''),
(301020, 'fdsg', '2022-10-14 16:15:26', 19, 4011, ''),
(301021, 'c<zxc', '2022-10-14 16:18:58', 19, 4010, ''),
(301022, 'sdf', '2022-10-14 16:20:54', 19, 4012, ''),
(301023, 'ps', '2022-10-14 16:31:51', 10, 4010, ''),
(301024, 'hola', '2022-10-14 09:32:46', 19, 4012, ''),
(301025, 'as', '2022-10-14 16:34:53', 19, 4012, ''),
(301026, 'camisa hombre', '2022-10-14 09:35:25', 19, 4012, ''),
(301027, 'chaqueta unisex', '2022-10-14 09:36:34', 19, 4015, ''),
(301028, 'falda', '2022-10-14 09:57:02', 19, 4028, ''),
(301029, 'falda', '2022-10-14 10:40:33', 19, 4010, ''),
(301030, 'falda', '2022-10-14 10:45:42', 19, 4010, ''),
(301034, 'falda', '2022-10-14 11:01:47', 19, 4013, ''),
(301038, 'falda', '2022-10-14 11:30:34', 19, 4014, ''),
(301039, 'falda', '2022-10-14 11:37:04', 19, 4014, ''),
(301040, 'falda', '2022-10-14 12:10:57', 19, 4014, ''),
(301041, 'falda', '2022-10-14 12:11:59', 19, 4014, ''),
(301042, 'falda', '2022-10-14 12:13:43', 19, 4013, ''),
(301043, 'falda', '2022-10-14 12:19:55', 19, 4012, ''),
(301044, 'camisa hombre', '2022-10-14 17:45:16', 19, 4012, ''),
(301045, 'camisa hombre', '2022-10-26 22:09:11', 19, 4033, ''),
(301046, 'camisa hombre', '2022-10-27 15:34:25', 19, 4033, ''),
(301047, 'camisa hombre', '2022-10-27 19:17:48', 19, 4034, ''),
(301048, 'camisa hombre', '2022-10-30 22:10:30', 19, 4034, ''),
(301049, 'camisa hombre', '2022-10-30 22:13:46', 19, 4034, ''),
(301051, 'camisa hombre', '2022-10-30 23:18:37', 19, 4034, 'si'),
(301052, 'camisa hombre', '2022-10-30 23:20:38', 19, 4033, 'no'),
(301053, 'camisa hombre', '2022-10-30 23:32:07', 19, 4034, 'si');
...
--
ALTER TABLE `detalle_de_compras`
  MODIFY `id_detalle_compras` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=202036;

--
-- AUTO_INCREMENT de la tabla `detalle_de_pedido`
--
ALTER TABLE `detalle_de_pedido`
  MODIFY `id_detalle_pedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8106;

--
-- AUTO_INCREMENT de la tabla `envios`
--
ALTER TABLE `envios`
  MODIFY `id_envio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6016;
...
--
ALTER TABLE `pedido`
  MODIFY `id_pedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4035;

--
-- AUTO_INCREMENT de la tabla `pqrs`
--
ALTER TABLE `pqrs`
  MODIFY `id_pqrs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5019;

--
-- AUTO_INCREMENT de la tabla `producto`
--
ALTER TABLE `producto`
  MODIFY `id_producto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9042;
...
--
ALTER TABLE `roles_usuarios`
  MODIFY `id_rol_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2056;
...
--
ALTER TABLE `venta`
  MODIFY `id_venta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=301054;
